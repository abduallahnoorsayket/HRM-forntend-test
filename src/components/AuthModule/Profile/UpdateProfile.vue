  ...
  methods: {
    editUser() {
      ...
      axios
        ...
        .then((response) => {
          ...
          console.log(response);
          if (this.loadVoiceCustomization()) {
             console.log("650 true");
          } else {
            console.log("652 false");
          }
          // voice defaultset up
          // axios
          //   .post("voice-config/", {
          //     accent:
          //       response.data.gender == "FL"
          //         ? 3
          //         : response.data.gender == "ML"
          //         ? 2
          //         : 0,
          //     voice_mode: "FO",
          //     volume: 1,
    ...
    loadVoiceCustomization() {
      ...
      axios
        .get("voice-config/", {})
        .then((response) => {
          this.Voice_custom_data = response.data;
          // filter by user
          this.Voice_custom_data.filter((element) => {
